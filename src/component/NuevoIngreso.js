...
const NuevoIngreso = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Lógica para crear el nuevo ingreso (enviar a la API o manejarlo localmente)
    console.log('Nuevo ingreso:', nuevoIngreso);

    // Redirigir de vuelta a la página de ingresos
    navigate('/otros-ingresos');
  };
  ...
  return (
    <div style={{ marginTop: '120px', padding: '20px', maxWidth: '75%', marginLeft: '   18%' }}>
      <Typography variant="h4" gutterBottom>Nuevo Ingreso</Typography>
