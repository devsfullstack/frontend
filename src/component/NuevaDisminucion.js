...
const NuevaDisminucion = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const nuevaDisminucion = { cantidad, producto, notaInterna };
    console.log('Nueva Disminución:', nuevaDisminucion);
    navigate('/disminuciones');
  };
  ...
  return (
    <div style={{ marginTop: '120px', padding: '20px', maxWidth: '75%', marginLeft: '18%' }}>
      <Typography variant="h4" gutterBottom>Nueva Disminución</Typography>
...
export default NuevaDisminucion;
